...
{   
    ...
    #pragma region Novas Armas de Ataque e Defesa
        ...
        ArmaDefesa* descobridorDosSeteMares = new DescobridordosSeteMares("Um lança-foguetes adornado com temas náuticos.",60);
    ...
    #pragma endregion
        ...
        Personagem* scoutRed = new Scout(1, "Scout vermelho", 150, refrisgarda, escudoEsplendido);


        Personagem* chavesBlue = new Chaves(2, "Chaves Azul", 150, lancarcoIris, tarjaDeInvestida);
        Personagem* demomanBlue = new Demoman(2, "Demoman Azul", 200, justicaVingadora, descobridorDosSeteMares);
        Personagem* pyroBlue = new Pyro(2, "Pyro Azul", 150, refrisgarda, sandviche);
        ...
        simulador->adicionarPersonagem(soldierRed, 1);
        ...
        simulador->adicionarPersonagem(pyroBlue, 2);
